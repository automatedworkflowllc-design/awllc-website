...
.fl-check{border:1px solid var(--line);border-radius:.6rem;padding:.8rem 1rem;background:var(--well)}
...
.fl-run{border:1px solid var(--line);border-radius:12px;background:var(--well);padding:1.3rem;margin:1.6rem 0 0}
