...
padding:.55rem .7rem;background:var(--bg-soft,var(--well,#ECE8DB));border-radius:.45rem;
...
background:var(--bg-soft,var(--well,#ECE8DB));font-size:.9rem;color:var(--ink-soft)}
...
background:var(--bg-soft,var(--well,#ECE8DB))}
